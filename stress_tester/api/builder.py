...
from stress_tester.scenarios.builder import detect_backend, detect_backends, generate_scenario, _validate_parsed
from stress_tester.scenarios.explorer import explore_and_build
...
def _scenarios_dir(request: Request) -> Path:
    ...
    d = settings.stress_tester_data_dir / "scenarios"
